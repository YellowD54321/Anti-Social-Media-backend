...
```bash
anti-social-media-backend$ sam build
```
...
```bash
anti-social-media-backend$ sam local invoke HelloWorldFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
anti-social-media-backend$ sam local start-api
anti-social-media-backend$ curl http://localhost:3000/
```
...
```bash
anti-social-media-backend$ sam logs -n HelloWorldFunction --stack-name anti-social-media-backend --tail
```
...
```bash
anti-social-media-backend$ cd hello-world
...
```bash
sam delete --stack-name anti-social-media-backend
```
